...
public class UserHomeView {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					UserHomeView window = new UserHomeView();
	...
	private void initialize() {
		...
		productManagerbutton.setBounds(0, 68, 160, 29);
		panel.add(productManagerbutton);
		
		JButton employManageButton = new JButton("Quản lý nhân viên");
		employManageButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
			}
		});
		employManageButton.setBounds(0, 120, 160, 29);
		panel.add(employManageButton);
		
		JButton billManageButton = new JButton("Quản lý đơn hàng");
		billManageButton.setBounds(0, 169, 160, 29);
		panel.add(billManageButton);
		
		JButton promotionManagerButton = new JButton("Quản lý khuyến mãi");
		promotionManagerButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
			}
		});
		promotionManagerButton.setBounds(0, 223, 160, 29);
		panel.add(promotionManagerButton);
		
		JButton MoneyToTalButton = new JButton("Thống kê doanh thu");
		MoneyToTalButton.setBounds(0, 271, 160, 29);
		panel.add(MoneyToTalButton);
		
		JButton viewTopButton = new JButton("Sản phẩm bán chạy");
		viewTopButton.setBounds(0, 318, 160, 29);
		panel.add(viewTopButton);
