...
public class SendMail {
	private String otp;
	private final String EMAIL = "chiminhcau2348@gmail.com";
	private final String PASSWORD = "dnqd azgi gwkw mery";
	...
	public boolean sendOtp(String email) {
		...
		String content = "<html lang=\"vi\"><head><meta charset=\"utf-8\"></head>" + "<body>" + "<p>Xin chào " + email
				+ ",</p>" + "<p>Chúng tôi đã xử lý yêu cầu của bạn về mã xác minh cho tài khoản Phone YP.</p>"
				+ "<p>Mã xác minh của bạn là: <b>" + otp + "</b></p>"
				+ "<p>Nếu bạn không yêu cầu mã này, xin hãy bỏ qua email này.</p>"
				+ "<p>Xin cảm ơn, <br>Phone Store</p>" + "</body></html>";
	...
	public boolean sendNewPassword(String email, String newPassword) {
		...
		String content = "<html lang=\"vi\"><head><meta charset=\"utf-8\"></head>" + "<body>" + "<p>Xin chào " + email
				+ ",</p>" + "<p>Chúng tôi đã xử lý yêu cầu của bạn về mã xác minh cấp lại mật khẩu cho tài khoản Phone YP.</p>"
				+ "<p>Mã xác minh của bạn là: <b>" + otp + "</b></p>"
				+ "<p>Nếu bạn không yêu cầu mã này, xin hãy bỏ qua email này.</p>"
				+ "<p>Xin cảm ơn, <br>Phone Store</p>" + "</body></html>";
